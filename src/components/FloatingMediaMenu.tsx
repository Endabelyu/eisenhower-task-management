...
export function FloatingMediaMenu() {
  ...
  if (!isSpotifyEnabled) {
    return (
      <div id="tour-media" className="fixed bottom-[88px] landscape:bottom-[80px] landscape:scale-90 origin-bottom-right md:bottom-6 right-4 md:right-6 z-50">
        <RadioPlayer />
      </div>
    );
  }
  ...
  return (
    <div id="tour-media" ref={menuRef} className="fixed bottom-[88px] landscape:bottom-[80px] landscape:scale-90 origin-bottom-right md:bottom-6 right-4 md:right-6 z-50 flex flex-col-reverse items-end gap-3">
      {/* Main Toggle Button */}
      <Button
        size="icon"
